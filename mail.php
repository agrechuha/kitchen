...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $content = $name . ' оставил заявку на рассчет стоимости изготовления кухонного гарнитура. Его телефон: ' . $phone;

    // Первый параметр - кому отправляем письмо, второй - тема письма, третий - содержание
    $success = mail("shef@gmail.com", 'Запрос на рассчет стоимости', $content);
